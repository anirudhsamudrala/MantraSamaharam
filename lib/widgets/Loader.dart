/*
credits: https://github.com/samarthagarwal/FlutterScreens/blob/master/lib/loaders/color_loader_3.dart
*/
...
class ColorLoader3 extends StatefulWidget {
  ...
  ColorLoader3({this.radius = 30.0, this.dotRadius = 3.0,this.width=100,this.height=100});
